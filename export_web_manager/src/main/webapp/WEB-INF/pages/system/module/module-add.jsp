        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/system/module/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <select id="ModuleParent" class="form-control"
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" onclick="chooseParentModule(0)" name="ctype"
                                                             value="0">主菜单</label></div>
                            <div class="radio"><label><input type="radio" onclick="chooseParentModule(1)" name="ctype"
                                                             value="1">二级菜单</label></div>
                            <div class="radio"><label><input type="radio" onclick="chooseParentModule(2)" name="ctype"
